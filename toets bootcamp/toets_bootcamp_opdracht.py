...
# a: Waarom is Visual Studio Code handiger voor software development dan bijvoorbeeld Notepad (kladblok)? 
# Noem de voordelen!


# met visual studio code kan je code oplsaan en controleren of het goed gaat of fout en met noodblok kan je alleen maar noteren

# b: Waarom is het goed dat je de commits van jouw code pusht naar github.com?
 # dan is het ingeleverd en het wordt opgeslagen
...
# c = "Hallo wereld" # dit is een voorbeeld van het datatype:variable
...
# getal2 = 5
# getal3 = 12
# antwoord = print(getal1, getal2, getal3)# of de naam van je eigen functie.
